...
public class BasiliskAnimation {
	public static final AnimationDefinition walk = AnimationDefinition.Builder.withLength(1.0F).looping()
		...
		.addAnimation("tail_middle_end", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
	...
	public static final AnimationDefinition look_left = AnimationDefinition.Builder.withLength(2.375F)
		...
		public static final AnimationDefinition look_right = AnimationDefinition.Builder.withLength(2.7917F)
		.addAnimation("head", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.7917F, KeyframeAnimations.degreeVec(0.0F, 35.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(1.9167F, KeyframeAnimations.degreeVec(0.0F, 35.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
